...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnAnalizzaDistanza = ft.ElevatedButton(text="Analizza Aeroporti",
                                              on_click=self._controller.handleAnalizza)
        row1 = ft.Row([self._txtIn, self._btnAnalizzaDistanza], alignment=ft.MainAxisAlignment.CENTER)
